...
@pytest.mark.parametrize('maxwellian_moments', [False, True])
@pytest.mark.parametrize('stencil_name', [Stencil.D2Q9, Stencil.D3Q7])
def test_weight_calculation(method, maxwellian_moments, stencil_name):
    compare_weights(method, maxwellian_moments, stencil_name)
...
@pytest.mark.longrun
def test_weight_calculation_longrun(method, maxwellian_moments, stencil_name):
    compare_weights(method, maxwellian_moments, stencil_name)